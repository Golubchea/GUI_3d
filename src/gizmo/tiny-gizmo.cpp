...
#define mace_points1 0.15f
#define mace_points2 0.75f
#define SIZE 0.10

gizmo_context::gizmo_context_impl::gizmo_context_impl(gizmo_context * ctx) : ctx(ctx)
{
    std::vector<float2> arrow_points            = { { SIZE, 0 }, { SIZE, 0.02f },{ 0.9, 0.02f },{ 0.9, 0.09f },{ 1.45f, 0 } };
    std::vector<float2> mace_points             = { { mace_points1, 0 }, { mace_points1, 0.05f },{ 1, 0.05f },{ 1, 0.1f },{ mace_points2, 0.1f }, { mace_points2, 0 } };
    std::vector<float2> ring_points             = { { +0.025f, 1 },{ -0.025f, 1 },{ -0.025f, 1 },{ -0.025f, 1.1f },{ -0.025f, 1.1f },{ +0.025f, 1.1f },{ +0.025f, 1.1f },{ +0.025f, 1 } };
    mesh_components[interact::translate_x]      = { make_lathed_geometry({ 1,0,0 },{ 0,1,0 },{ 0,0,1 }, 8, arrow_points), { 1,0.7f,0.7f, 1.f }, { 1,0,0, 1.f } };
    mesh_components[interact::translate_y]      = { make_lathed_geometry({ 0,1,0 },{ 0,0,1 },{ 1,0,0 }, 8, arrow_points), { 0.7f,1,0.7f, 1.f }, { 0,1,0, 1.f } };
    mesh_components[interact::translate_z]      = { make_lathed_geometry({ 0,0,1 },{ 1,0,0 },{ 0,1,0 }, 8, arrow_points), { 0.7f,0.7f,1, 1.f }, { 0,0,1, 1.f } };
    mesh_components[interact::translate_yz]     = { make_box_geometry({ -0.01f,0.05,0.05 },{ 0.01f,0.5f,0.5f }), { 0.5f,1,1, 0.5f }, { 0,1,1, 0.6f } };
    mesh_components[interact::translate_zx]     = { make_box_geometry({ 0.05,-0.01f,0.05 },{ 0.5f,0.01f,0.5f }), { 1,0.5f,1, 0.5f }, { 1,0,1, 0.6f } };
    mesh_components[interact::translate_xy]     = { make_box_geometry({ 0.05,0.05,-0.01f },{ 0.5f,0.5f,0.01f }), { 1,1,0.5f, 0.5f }, { 1,1,0, 0.6f } };
    ...
    mesh_components[interact::rotate_x]         = { make_lathed_geometry({ 1,0,0 },{ 0,1,0 },{ 0,0,1 }, 40, ring_points, 0.003f), { 1, 0.5f, 0.5f, 1.f }, { 1, 0, 0, 1.f } };
    mesh_components[interact::rotate_y]         = { make_lathed_geometry({ 0,1,0 },{ 0,0,1 },{ 1,0,0 }, 40, ring_points, -0.003f), { 0.5f,1,0.5f, 1.f }, { 0,1,0, 1.f } };
    mesh_components[interact::rotate_z]         = { make_lathed_geometry({ 0,0,1 },{ 1,0,0 },{ 0,1,0 }, 40, ring_points), { 0.5f,0.5f,1, 1.f }, { 0,0,1, 1.f } };
    mesh_components[interact::scale_x]          = { make_lathed_geometry({ 1,0,0 },{ 0,1,0 },{ 0,0,1 }, 8, mace_points),{ 1,0.5f,0.5f, 1.f },{ 1,0,0, 1.f } };
    mesh_components[interact::scale_y]          = { make_lathed_geometry({ 0,1,0 },{ 0,0,1 },{ 1,0,0 }, 8, mace_points),{ 0.5f,1,0.5f, 1.f },{ 0,1,0, 1.f } };
    mesh_components[interact::scale_z]          = { make_lathed_geometry({ 0,0,1 },{ 1,0,0 },{ 0,1,0 }, 8, mace_points),{ 0.5f,0.5f,1, 1.f },{ 0,0,1, 1.f } };
}
